ActionController::Routing::Routes.draw do |map|
  ...
  map.home(':page', :controller => 'static', :action => 'show')
  map.home(':section/:page', :controller => 'static', :action => 'show')
  map.home(':section/:subsection/:page', :controller => 'static', :action => 'show')
end
